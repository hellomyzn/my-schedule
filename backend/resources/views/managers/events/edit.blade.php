        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="max-w-2xl py-4 mx-auto">
                    ...
                    <form method="POST" action="{{ route('managers.events.update', $event->id) }}">
                        @csrf
                        @method('put')
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea row="3" id="information" class="block mt-1 w-full" name="information" required > {{ $event->information }}</x-textarea> 
                        </div>
